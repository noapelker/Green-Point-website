...
export const aboutNew2 = 'חברת גרין פוינט, מפתחת ומייצרת בישראל את הבית החכם מסדרת ' +
    ...
    'המערכת מתאימה לבית חדש או קיים כאחד ומאפשרת הפיכת בית לחכם וחסכוני על ידי ' +
...
export const aboutNewSec = 'המערכת פועלת באמצעות שילוב בין מפסקים חכמים, חיישנים, מגשרים ולוח מקשים.\n' +
    ...
    '\n המגשרים מתקשרים עם הבית ובכך מאפשרים שליטה מרחוק במוצרי החשמל ויחידות מערכת הבית החכם באמצעות האפליקציה.\n' +
    'במערכת Green Point, ניתן דגש רב לאיכות החומרים ועיצוב המוצרים למתן מראה חזק חדשני ויוקרתי.\n';
